                    ...
                    <div class="navbar-inner filter">
                        <ul class="sui-nav">
                            <li :class="{ active: isOne }" @click="changeOrder(1)">
                                <a>综合
                                    <span v-show="isOne" class="iconfont" :class="{ 'icon-todown': isDesc, 'icon-up': isAsc }"></span></a>
                            </li>
...
export default {
    ...
    mounted() {
        /* 在发送请求之前带给服务器参数[searchParams参数变化有数值带给服务器] */
        this.getData();
    },
    computed: {
        /*  ...mapState({
